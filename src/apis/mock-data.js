export const mockData = {
  board: {
    _id: 'board-id-01',
    title: 'Cuong PC MERN Stack Board',
    ...
    columns: [
      ...
      },
      {
        ...
        cardOrderIds: ['column-id-4-place-holder-card'],
        //handle bug which cannot drag card to empty column by create a cards with FE_PlaceHolderCard props and attach it in empty column (this card always hiden)
        cards: [
          {
            _id: 'column-id-4-place-holder-card',
            boardId: 'board-id-01',
